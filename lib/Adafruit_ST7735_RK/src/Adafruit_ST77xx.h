...
#include "../lib/Adafruit_GFX_RK/src/Adafruit_SPITFT_Macros.h"
...
class Adafruit_ST77xx : public Adafruit_SPITFT {
  ...
  Adafruit_ST77xx(::particle::SpiProxy<HAL_SPI_INTERFACE1> *spiProxy, int8_t cs, int8_t rs, int8_t rst) : 
    Adafruit_ST77xx(&spiProxy->instance(), cs, rs, rst) {};

#if Wiring_SPI1
  Adafruit_ST77xx(::particle::SpiProxy<HAL_SPI_INTERFACE2> *spiProxy, int8_t cs, int8_t rs, int8_t rst) : 
    Adafruit_ST77xx(&spiProxy->instance(), cs, rs, rst) {};
#endif

#if Wiring_SPI2
  Adafruit_ST77xx(::particle::SpiProxy<HAL_SPI_INTERFACE3> *spiProxy, int8_t cs, int8_t rs, int8_t rst) : 
    Adafruit_ST77xx(&spiProxy->instance(), cs, rs, rst) {};
#endif
