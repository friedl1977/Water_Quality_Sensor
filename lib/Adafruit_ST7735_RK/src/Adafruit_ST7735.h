...
class Adafruit_ST7735 : public Adafruit_ST77xx {
  ...
  Adafruit_ST7735(::particle::SpiProxy<HAL_SPI_INTERFACE1> *spiProxy, int8_t cs, int8_t dc, int8_t rst) : 
    Adafruit_ST7735(&spiProxy->instance(), cs, dc, rst) {};

#if Wiring_SPI1
  Adafruit_ST7735(::particle::SpiProxy<HAL_SPI_INTERFACE2> *spiProxy, int8_t cs, int8_t dc, int8_t rst) : 
    Adafruit_ST7735(&spiProxy->instance(), cs, dc, rst) {};
#endif

#if Wiring_SPI2
  Adafruit_ST7735(::particle::SpiProxy<HAL_SPI_INTERFACE3> *spiProxy, int8_t cs, int8_t dc, int8_t rst) : 
    Adafruit_ST7735(&spiProxy->instance(), cs, dc, rst) {};
#endif
